                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
                            <div class="slider-content-2 slider-animated-1">
                                ...
                                <div class="slider-btn">
                                    <a class="animated" href="product-details.php?productId=12">Купить <i class="sli sli-basket-loaded"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
                            <div class="slider-content-2 slider-animated-1">
                                ...
                                <div class="slider-btn">
                                    <a class="animated" href="product-details.php?productId=1">Купить<i class="sli sli-basket-loaded"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-4 col-6">
                        <div class="footer-widget mb-40 pl-50">
                            ...
                            <div class="footer-list">
                                <ul>
                                    <li><a href="login-register.php">Логин</a></li>
