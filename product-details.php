                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product-details-img">
                        <div class="zoompro-border zoompro-span">
                            <img class="zoompro" src="assets/img/product-details/product-detalis-l1.jpg" data-zoom-image="assets/img/product-details/id3/product-detalis-bl1.jpg" alt="" />           <span>-29%</span>
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="description-review-wrapper">
                        <div class="description-review-topbar nav">
                            <a class="active" data-toggle="tab" href="#des-details1">Подробнее: </a>
                            <a data-toggle="tab" href="#des-details3">Доп. информация</a>
                        </div>
